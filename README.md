...
|---|---|---|
| Full Python suite | 1247 passed, 3 skipped | Local host test; skips require unavailable Windows symlink creation |
| Branch-aware coverage | 95.72% across 12,372 statements and 3,226 branches | Local host test |

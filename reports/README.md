...
- [MSP430 connection and Dashboard observation](MSP430_CONNECTION_AND_DASHBOARD_OBSERVATION_2026-09-04.md) — bounded Windows USB/UART pass followed by device absence, plus non-mutating Dashboard checks; not long-duration stability, firmware, protocol, measurement, or ForgeGate hardware-integration proof
